...
$options = array( 'site'=>'site', 'type'=>'components', 'ext'=>'com_mongodisplay' );

// Require the base controller
Mongodisplay::load( 'MongodisplayController', 'controller', $options );

// Require specific controller if requested
$controller = JRequest::getWord('controller', JRequest::getVar( 'view' ) );
if (!Mongodisplay::load( 'MongodisplayController'.$controller, "controllers.$controller", $options ))
    $controller = '';
