...
class Mongodisplay extends DSC
{
    protected $_name = 'mongodisplay';
    ...
    {
        $query = "SELECT * FROM #__mongodisplay_config";
        return $query;
    }
    ...
    {
        $cache = JFactory::getCache('com_mongodisplay.defines');
     ...
     *
     * Usage: $object = Mongodisplay::getClass( 'MongodisplayHelperCarts', 'helpers.carts' );
     * Usage: $suffix = Mongodisplay::getClass( 'MongodisplayHelperCarts', 'helpers.carts' )->getSuffix();
     * Usage: $categories = Mongodisplay::getClass( 'MongodisplaySelect', 'select' )->category( $selected );
     *
     ...
     */
    public static function getClass( $classname, $filepath='controller', $options=array( 'site'=>'admin', 'type'=>'components', 'ext'=>'com_mongodisplay' )  )
    {
     ...
     * @return boolean
     */
    public static function load( $classname, $filepath='controller', $options=array( 'site'=>'admin', 'type'=>'components', 'ext'=>'com_mongodisplay' ) )
    {
