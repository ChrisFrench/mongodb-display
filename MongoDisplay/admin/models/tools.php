...
class MongodisplayModelTools extends MongodisplayModelBase 
{	
    protected function _buildQueryWhere(&$query)
    {
		...
		$query->where("LOWER(tbl.folder) = 'mongodisplay'");
	...
	public function getList($refresh = false)
	{
		if ($list = parent::getList($refresh)) 
		{
		    ...
		    {
		        $item->link = 'index.php?option=com_mongodisplay&view=tools&task=view&id='.$item->id;
		    }		    
		} 
